...
public class MainActivity extends Activity {
 ...
 //   private static final String URL = "https://pokeapi.co/api/v2/pokemon/1";
    ...
    private void carregarImagemLink (String url) {
    ...
    public  void callPokemon(View view){
        String nomePoke = nomePokemon.getText().toString();
        String URL = "https://pokeapi.co/api/v2/pokemon/" + nomePoke;
